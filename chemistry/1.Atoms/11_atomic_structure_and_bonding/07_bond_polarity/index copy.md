...
the bonding electrons are not shared equally between the two atoms. Covalent bonds may, therefore,
...
putting partial charges (ä+ and ä.) above the atoms.
...
going to be electron rich; therefore, bonds may Table 2.2 Pauling electronegativity values
H
2.1
Li Be B C N O F
...
chloroform (CHCl3) has a dipole moment (1.02 D),
carbon tetrachloride (CCl4) has no overall dipole.
...
positive (ä+); consequently, electrons in the C–C
bond are drawn towards this partial positive charge.
The terminal carbon thus also experiences a partial
positive charge, somewhat smaller than ä+ and so
depicted as ää+.

This transmission of polarity through the ó bonds
