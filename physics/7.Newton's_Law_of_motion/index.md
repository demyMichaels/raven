...
xi. establish expressions for the range, maximum height and time of flight of
projectiles, rockets, missles;

xii. solve problems involving projectile motion;

xiii. solve numerical problems involving impulse and momentum;

xiv. interpretation of area under force –
time graph;
...
xx. solve numerical problems involving
motion in a circle;

xxi. establish the relationship between
